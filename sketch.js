...
//Criar os sprites
   ...
   // bk = createSprite(300,300);   O texto não aparecia se o fundo era um sprite
...
function draw() {
   background(backGroundImg); //Passei imagem diretamente aqui
    fill("white")
    textSize(20)
    ...
    //}
     ...
     passaro.overlap(cloudsGroup, function(collector, collected){ //Problema resolvido
         score=score+1;
         collected.remove();
     });
